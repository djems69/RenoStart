            ...
            <div className="bg-gray-100 rounded-lg p-8">
              <div className="grid grid-cols-2 gap-6">
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-900">Expertise BTP</h3>
                  <p className="text-sm text-gray-600 mt-2">Spécialisation sectorielle</p>
                </div>
                <div className="text-center">
                  ...
                  <h3 className="font-semibold text-gray-900">Certification Qualiopi</h3>
                  <p className="text-sm text-gray-600 mt-2">En cours de préparation</p>
                </div>
              </div>
            </div>
          </div>
