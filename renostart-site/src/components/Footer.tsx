        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/formations" className="text-gray-300 hover:text-white transition-colors duration-200">
                  Formations
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <p>Spécialiste BTP</p>
              <p className="mt-4">
                <a href="mailto:contact@renostart-conseil.fr" className="hover:text-white transition-colors duration-200">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 RenoStart Conseil. Tous droits réservés.
            </p>
