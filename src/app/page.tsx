...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      ...
      <section className="pt-8 pb-6 sm:pt-20 sm:pb-10 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="pt-6 pb-16 sm:pt-10 sm:pb-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Expertise BTP */}
            <div className="bg-white rounded-lg shadow-lg p-8 border border-neutral-200 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-neutral-900 mb-4">Optimiser leur organisation</h3>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border border-neutral-200 hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-neutral-900 mb-4">Valoriser leur compétences</h3>
              <p className="text-neutral-600 leading-relaxed">
